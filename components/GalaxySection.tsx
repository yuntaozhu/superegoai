    ...
    <section className="relative py-20 md:py-32 overflow-hidden px-4">
      ...
      <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 md:mb-24 px-4">
          ...
          <h2 className="text-3xl md:text-6xl font-black text-white mb-4 md:mb-6 uppercase tracking-tighter">
            {t('galaxy.title')}
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
          {courses.map((course) => (
            <Link 
              key={course.id} 
              to={`/course/${course.id}`}
              className="group relative bg-white/5 border border-white/10 rounded-[32px] md:rounded-[40px] p-8 md:p-10 hover:border-blue-500/40 transition-all duration-500 hover:-translate-y-2 shadow-xl backdrop-blur-xl flex flex-col h-full overflow-hidden"
            >
              {/* Internal Glow */}
              ...
              <div className="flex items-center justify-between mb-6 md:mb-8">
                ...
                <span className="text-[8px] md:text-[10px] font-mono text-gray-500 uppercase tracking-widest bg-white/5 px-2 md:px-3 py-1 rounded-full border border-white/5">
                  {course.id.toUpperCase()} // LVL 01
                </span>
              </div>
              
              <h3 className="text-xl md:text-2xl font-black text-white mb-3 md:mb-4 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-blue-400 transition-all duration-300">
                {course.title}
              </h3>
              ...
              <div className="space-y-3 md:space-y-4 mb-6 md:mb-8 flex-grow">
                 <div className="flex items-center gap-2 md:gap-3">
                    ...
                    <span className="text-xs md:text-sm text-gray-300 font-bold">{course.target}</span>
                 </div>
                 <p className="text-[13px] md:text-sm text-gray-400 leading-relaxed font-light line-clamp-3">
                   {course.description}
                 </p>
              </div>
              
              <div className="mt-auto flex items-center justify-between">
                <div className="flex items-center text-blue-400 text-[10px] md:text-xs font-black uppercase tracking-widest gap-2">
                ...
                <div className="text-[9px] md:text-[10px] font-mono text-gray-600 group-hover:text-blue-500/50 transition-colors">
        ...
        <div className="mt-20 md:mt-32 bg-white/5 rounded-[40px] md:rounded-[60px] p-10 md:p-20 border border-white/10 text-center max-w-5xl mx-auto backdrop-blur-xl relative overflow-hidden group">
           ...
           <div className="relative z-10">
              ...
              <h3 className="text-2xl md:text-5xl font-black text-white mb-4 md:mb-6 uppercase tracking-tighter">
                {t('galaxy.core_title')}
              </h3>
              <p className="text-base md:text-xl text-gray-400 max-w-3xl mx-auto font-light leading-relaxed mb-8 md:mb-10">
                {t('galaxy.core_desc')}
              </p>
