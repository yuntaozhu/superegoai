...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed w-full z-50 bg-white/80 dark:bg-brand-dark/90 backdrop-blur-xl border-b border-gray-200 dark:border-white/5 transition-colors duration-300">
      ...
      {/* Mobile Menu Overlay */}
      {isOpen && (
        <div className="md:hidden fixed inset-0 top-[64px] z-40 bg-white dark:bg-brand-dark/95 backdrop-blur-3xl animate-in fade-in slide-in-from-top-4 duration-300 overflow-y-auto">
